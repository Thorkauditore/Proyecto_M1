...
document.querySelector("input[type='submit']").addEventListener("click", (e) => {
  ...
  document.querySelector("#imgTeams").innerHTML = `<img src="./teams/${teams[datosEquipo].abbreviation}.png" alt="vaya">`
  document.querySelector("#imgPlayers").innerHTML = `<img src="./jugadores/${teams[datosEquipo].abbreviation}.png" alt="vaya">`
